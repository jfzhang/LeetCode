...
leftmost revision being revision 0, the next revision being revision 1, and so on. For example 2.5.33 and 0.1 are valid version numbers.
...
def compareVersion(version1: str, version2: str) -> int:
    ...
    for i in range(max(len1, len2)):
        x1 = int(v1[i]) if i < len1 else 0
        x2 = int(v2[i]) if i < len2 else 0
